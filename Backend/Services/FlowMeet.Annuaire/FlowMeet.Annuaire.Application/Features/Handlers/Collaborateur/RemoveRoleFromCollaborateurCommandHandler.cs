...
{
    public class RemoveRoleFromCollaborateurCommandHandler : IRequestHandler<RemoveRoleFromCollaborateurCommand, Result<Unit>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly IPublisher<RoleRemovedFromCollaborateurEvent> publisher;
        public RemoveRoleFromCollaborateurCommandHandler(IUnitOfWork unitOfWork, IPublisher<RoleRemovedFromCollaborateurEvent> publisher)
        {
            this.unitOfWork = unitOfWork;
            this.publisher = publisher;
        }

        public async Task<Result<Unit>> Handle(RemoveRoleFromCollaborateurCommand request, CancellationToken cancellationToken)
        {
