...
namespace FlowMeet.ServiceRendezVous.Infrastructure.Extensions
{
    public static class DatabaseExtensions
    {
        public static async Task Migrate(this IApplicationBuilder app)
        {
            ...
            FlowMeetServiceRendezVousDbContext dbContext =
               scope.ServiceProvider.GetRequiredService<FlowMeetServiceRendezVousDbContext>();
